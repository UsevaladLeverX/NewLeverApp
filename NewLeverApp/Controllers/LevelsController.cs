...
namespace NewLeverApp.Controllers
{
    public class LevelsController : Controller
    {
        ...
        public LevelsController(LeverAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LevelId,Position")] Level level)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LevelId,Position")] Level level)
        {
            if (id != level.LevelId)
            {
                return NotFound();
